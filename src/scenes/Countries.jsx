...
const ExploreCountry = ({ image, country, index }) => {
  return (
    <motion.div
      variants={fadeIn("right", "spring", index * 0.5, 0.75)}
      className="flex flex-col items-center justify-center"
    >
      <Tilt options={{ max: 25, scale: 1, speed: 250 }}>
        <img
          src={image}
          alt={country}
    ...
    <section>
      <div className="w-5/6 mx-auto mt-6">
        ...
        >
          ...
          <p className="mt-2">
            BestTravel offers great deals for you. You can easily travel and{" "}
            <br />
            explore over 10+ Euoropean countries with one simple touch.
          </p>
